...
## The path to the chart resource.
@export_file("*.res",'*.tres','*.json') var chart: String = ''
@export_group("Optional")
## Optional path to a unique scene to be used in this for this song. if empty, the Song's scene will be used.
@export_file("*.tscn","*.scn") var scene: String = ''
## Optional path to a seperate events resource.
